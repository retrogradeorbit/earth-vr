(defproject earth-vr "0.1.0-SNAPSHOT"
  ...
  :cljsbuild {:builds
              [{:id "dev"
                ...
                :figwheel {:on-jsload "earth-vr.core/on-js-reload"}

                :compiler {:main earth-vr.core
                           :asset-path "js/compiled/out"
                           :output-to "resources/public/js/compiled/earth_vr.js"
